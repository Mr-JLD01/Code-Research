...
class LinearCode:
    def __init__(self, codewords: list[str]):
        ...
        self.gen_matrix = LinearCode.generator_matrix(codewords)
        self.k = len(self.gen_matrix)
    ...
    def __str__(self) -> str:
        ...
        return_string += "A ({0}, {1}, {2}) or [{0}, {3}] Code over a {4}-field\n".format(self.word_size, self.num_words, self.distance, self.k, self.q_field)  # noqa
